  ...
  const handleLicensePlate = async () => {
    ...
    if (!trimmedPlate) {
      ...
      newErrors.licensePlate =
        'License plate must be 2–8 characters, uppercase letters and numbers only.';
    }
        ...
        <View style={{ width: '100%', alignItems: 'center', paddingBottom: 100 }}>
          ...
          <FormControl style={authStyle.formControl} isInvalid={true}>
            ...
            <Input
              variant="outline"
              size="xl"
              style={[authStyle.input, !!errors.firstName && { borderColor: 'red' }]}
            >
              <InputField
                placeholder="John"
                value={firstName}
          ...
          <FormControl style={authStyle.formControl} isInvalid={true}>
            ...
            <Input
              variant="outline"
              size="xl"
              style={[authStyle.input, !!errors.lastName && { borderColor: 'red' }]}
            >
              <InputField
                placeholder="Doe"
                value={lastName}
          ...
          <FormControl style={authStyle.formControl} isInvalid={true}>
            ...
            <Input
              variant="outline"
              size="xl"
              style={[authStyle.input, !!errors.phoneNumber && { borderColor: 'red' }]}
            >
              <InputField
          ...
          <FormControl style={authStyle.formControl} isInvalid={true}>
            ...
            <Input
              variant="outline"
              size="xl"
              style={[authStyle.input, !!errors.repeatPassword && { borderColor: 'red' }]}
            >
              <InputField
                placeholder="••••••••"
        ...
        <>
          <FormControl style={authStyle.formControl} isInvalid={true}>
            ...
            <Input
              variant="outline"
              size="xl"
              style={[authStyle.input, !!errors.licensePlate && { borderColor: 'red' }]}
            >
              <InputField
                placeholder="ABC123"
                value={plateNumber}
